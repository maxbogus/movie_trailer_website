...
terminator_par2 = media.Movie('Terminator 2',
...
beverly_hills_cop = media.Movie('Beverly Hills Cop', 'Using rock music to learn',
                                'http://www.gstatic.com/tv/thumb/movieposters/8676/p8676_p_v8_aa.jpg',
                                'https://www.youtube.com/watch?v=XQGi4eB3RZI')

true_detective = media.Movie('True Detective',
                             'The first season, starring Matthew McConaughey, Woody Harrelson, Michelle Monaghan, Michael Potts, and Tory Kittles, takes place in Louisiana and follows a pair of Louisiana State Police homicide detectives, and their pursuit of a serial killer over a 17-year period.',
                             'http://www.gstatic.com/tv/thumb/tvbanners/11689212/p11689212_b_v8_ac.jpg',
                             'https://www.youtube.com/watch?v=mXG1netn9_g')

fargo = media.Movie('Fargo', 'Fargo is a black-comedy drama',
                    'http://www.gstatic.com/tv/thumb/tvbanners/12031927/p12031927_b_v8_aa.jpg',
                    'https://www.youtube.com/watch?v=gKs8DzjPDMU')

movies = [saw, terminator_par2, unforgiven, beverly_hills_cop, true_detective, fargo]
